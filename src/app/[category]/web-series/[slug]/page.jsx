...
export async function generateMetadata({ params }) {
  ...
  try {
    ...
    const pageUrl = `https://entertainindia.in/${category}/web-series/${slug}`;
    const ogImage = webseries.poster?.url || 'https://entertainindia.in/default-webseries-og.jpg';
  ...
  try {
    ...
    const breadcrumbLd = {
      ...
      "itemListElement": [
        ...
        { "@type": "ListItem", "position": 2, "name": breadcrumbCategoryName, "item": `https://entertainindia.in/${category}` },
        { "@type": "ListItem", "position": 3, "name": "वेब सीरीज", "item": `https://entertainindia.in/${category}/web-series` },
        { "@type": "ListItem", "position": 4, "name": mainData.title, "item": `https://entertainindia.in/${category}/web-series/${slug}` }
      ]
    };
    ...
    const seriesSchemaLd = {
      ...
      "@type": "TVSeries",
      "name": mainData.title,
      "url": `https://entertainindia.in/${category}/web-series/${slug}`,
      "description": mainData.description?.substring(0, 200) || `${mainData.title} वेब सीरीज के बारे में विवरण।`,
      "image": mainData.poster?.url || "https://entertainindia.in/default-webseries.jpg",
